...
#icon
image_icon = PhotoImage(file="resources/eraser.png")
root.iconphoto(False, image_icon)

color_box = PhotoImage(file="resources/color section.png")
Label(root, image=color_box, bg="#f2f3f5").place(x=10, y=10)

eraser = PhotoImage(file="resources/eraser.png")
...
canvas = Canvas(root, width=930, height=590, background="white", cursor="hand2")
...
slider.place(x=30, y=605)

#value label
value_label = ttk.Label(root, text=get_current_value())
value_label.place(x=27, y=640)
